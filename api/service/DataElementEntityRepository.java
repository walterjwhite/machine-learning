...
public class DataElementEntityRepository extends GenericEntityRepository<DataElement> {
  @Inject
  public DataElementEntityRepository(EntityManager entityManager, CriteriaBuilder criteriaBuilder) {
